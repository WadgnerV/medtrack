            ...
            <div style={{ background:'#f8f8f8', borderRadius:10, padding:'12px', marginBottom:12 }}>
              <div style={{ display:'flex', flexDirection:'column', gap:8, marginBottom:10 }}>
                ...
                {tratSeleccionado === 'otra' && (
                  <input placeholder="Nombre del tratamiento *" value={tratOtra} onChange={e => setTratOtra(e.target.value)} style={inp} />
                )}
                <input placeholder="Descripción (opcional)" value={tratDescription} onChange={e => setTratDescription(e.target.value)} style={inp} />
                <input placeholder="Dosis (opcional)" value={tratDosage} onChange={e => setTratDosage(e.target.value)} style={inp} />
              </div>
