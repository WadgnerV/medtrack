...
const BODY_ZONES_FACE = [
  ...
  { id:'entrecejo', label:'Entrecejo', cx:100, cy:62 },
  { id:'ojeras_izq', label:'Ojera izq.', cx:72, cy:90 },
  { id:'ojeras_der', label:'Ojera der.', cx:128, cy:90 },
  { id:'nariz', label:'Nariz', cx:100, cy:100 },
  { id:'pomulos_izq', label:'Pómulo izq.', cx:65, cy:82 },
  { id:'pomulos_der', label:'Pómulo der.', cx:135, cy:82 },
