...
export default function SpotifyBar({ returnTo = '/admin' }) {
  ...
  return (
    <>
      ...
      {expanded && (
        <div style={{ position: 'fixed', bottom: 80, right: 20, width: 580, height: 520, background: '#121212', borderRadius: 16, boxShadow: '0 8px 48px rgba(0,0,0,0.7)', zIndex: 1000, overflow: 'hidden', fontFamily: 'Inter, sans-serif', display: 'flex' }}
          onClick={e => e.stopPropagation()}>

          {/* Panel izquierdo — reproductor */}
          <div style={{ width: 360, flexShrink: 0, display: 'flex', flexDirection: 'column', borderRight: '1px solid #282828', background: 'linear-gradient(180deg, #1a1a2e 0%, #121212 60%)' }}>
            {/* Album art */}
