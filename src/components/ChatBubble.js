  ...
  return (
    <>
      ...
      <div onClick={() => { setOpen(p => !p); if (!open) loadConversations() }}
        style={{ position:'fixed', bottom:84, right:20, zIndex:1000, width:48, height:48, borderRadius:'50%', background:BLUE, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center', boxShadow:'0 4px 16px rgba(26,58,92,0.4)', transition:'transform 0.2s' }}
